...
I recommend running `make gen-templ` in a different terminal before starting so any changes to the .templ file will be generate the .go file automatically, leading to Air picking up the changes and reloading the server.
